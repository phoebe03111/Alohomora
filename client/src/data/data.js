...
import wineImg from "../assets/images/activities/paint.png";
import campfireImg from "../assets/images/activities/campfire.png";
...
export default function data() {
  return [
    ...
    },
    {
      ...
      img_src: wineImg,
      description:
        "Having a relaxing and fun time painting while having B.C. wine.",
    },
    {
      id: 12,
      name: "By The Campfire",
      img_src: campfireImg,
      description:
        "Have a cozy night by the campfire! In-person & remote friendly.",
    },
  ];
}
